...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-[var(--bg-primary)] dark:bg-[var(--bg-primary)] transition-colors duration-500 overflow-x-hidden font-sans selection:text-[var(--accent)] selection:bg-[var(--accent)]/20">
            
            {/* HERO SECTION - Redesigned Sassy Style */}
            <section ref={heroRef} className="relative min-h-screen flex flex-col items-center justify-start pt-32 pb-20 px-6 sm:px-12 overflow-hidden hero-sassy">
            ...
            <section ref={bentoRef} className="py-24 px-4 sm:px-6 max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-none md:grid-rows-2 gap-6 h-auto md:h-[550px]">
                    ...
                    <div className="bento-card col-span-1 md:col-span-2 row-auto md:row-span-2 relative overflow-hidden rounded-[32px] bg-white border border-slate-200 dark:bg-[var(--bg-surface)] dark:border-white/10 group transition-all duration-300 hover:shadow-2xl hover:shadow-emerald-500/10 dark:hover:border-emerald-500/30">
                        {/* Hover Glow Gradient */}
