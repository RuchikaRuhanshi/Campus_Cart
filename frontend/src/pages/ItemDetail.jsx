...
const ItemDetail = () => {
    ...
    if (loading) return (
        <div className="min-h-screen flex items-center justify-center bg-[#f8f0e2] dark:bg-[#0c0617]">
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-[var(--bg-primary)] dark:bg-[var(--bg-primary)] text-text-primary dark:text-white transition-colors duration-500 overflow-x-hidden">
